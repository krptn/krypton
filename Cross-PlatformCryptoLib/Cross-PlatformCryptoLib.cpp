...
extern "C"{
	__declspec(dllexport) std::tuple<char*, char> __cdecl AESEncrypt(unsigned char* text, unsigned char* key) {
	...
	__declspec(dllexport) char* __cdecl AESDecrypt(unsigned char* iv, unsigned char* key, unsigned char* ctext) {
	...
	__declspec(dllexport) PyObject* __cdecl AESEncryptPy(char* textb, char* keyb) {
	...
	__declspec(dllexport) PyObject* __cdecl AESDecryptPy(char* iv, char* key, char* ctext) {
		/*
