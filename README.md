...
We also have a [homepage](https://krptn.mbs9.org/) and [documentation](https://docs.krptn.mbs9.org/index.html) for you to check out.
...
**Wouldn't it be nice if encryption would also be handled?** Perhaps it could be handled in a **[way that keys are derived from credentials](https://krptn.mbs9.org/news/security-model/)**, such that, without the user entering credentials, not even the database administrator can read it?! This is exactly what we do!
...
We are building a user authentication and access management system (IAM) with **[data encryption at rest derived from credentials](https://krptn.mbs9.org/news/security-model/)**. It is available as a python extension module. However we have certain [limitations](https://krptn.mbs9.org/news/limitations/).
...
This gives you *[security from encryption](https://krptn.mbs9.org/news/security-model/)* without ever needing to even notice it! It protects you from server side attacks.
...
![Krptn Visualisation](https://krptn.mbs9.org/krptnDiagram.webp)
...
Have a look at our [User Authentication documentation](https://docs.krptn.mbs9.org/README-USER-AUTH.html), and create some users.

Ready to integrate it into your WebApp? Have a look at some of our integration's available with [Django and Flask](https://docs.krptn.mbs9.org/README.html#integration-with-web-frameworks)!
