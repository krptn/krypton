...
PYBIND11_MODULE(__CryptoLib, m)
{
	...
	m.def("decrypt", &decrypt, "A function which decrypts the data. Args: ctext, key.", py::arg("ctext"), py::arg("key"));
	m.def("encrypt", &encrypt, "A function which encrypts the data. Args: text, key.");
